...
use Plentymarkets\AmazonSellingPartnerAPI\Models\Sales\GetOrderMetricsResponse;
...
class SalesApi
{
     ...
     *
     * @return \Plentymarkets\AmazonSellingPartnerAPI\Models\Sales\GetOrderMetricsResponse
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Plentymarkets\AmazonSellingPartnerAPI\Models\Sales\GetOrderMetricsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Plentymarkets\AmazonSellingPartnerAPI\Models\Sales\GetOrderMetricsResponse';
        $request = $this->getOrderMetricsRequest($marketplace_ids, $interval, $granularity, $granularity_time_zone, $buyer_type, $fulfillment_network, $first_day_of_week, $asin, $sku);
